...
function page() {
    ...
    const toggleCamera = () => {
        if (!stream) return
        stream.getVideoTracks().forEach((trace) => trace.enabled = !isCameraOn);
...
<AnimatePresence>
    {showApprovalModal && (
        ...
        >
            ...
            <h2 className='text-lg font-semibold mb-4'>Conform Approval</h2>
            <div className='flex gap-4'>
            <button onClick={()=>setShowApprovalModel(false)} className='flex-1 border rounded-xl py-2'>Cancle</button>
...
<AnimatePresence>
    {showRejectionModal && (
        ...
        >
            ...
            <div className='flex gap-4'>
            <button onClick={()=>setShowRejectionModel(false)} className='flex-1 border rounded-xl py-2'>Cancle</button>
