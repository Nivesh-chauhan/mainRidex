...
function HeroSection({onAuthRequired}:{onAuthRequired:()=>void}) {
  ...
  return (
    <div className='related min-h-screen w-full overflow-hidden'>
      ...
      <div className='relative z-10 min-h-screen flex flex-col items-center justify-center px-4 text-center'>
        ...
        <motion.div
          ...
          className='text-white font-extrabold text-4xl sm:text-4xl md:text-7xl'
        >
          Book Any Vehicle
        </motion.div>
        <motion.p
        ...
        >
          From Daily ride to transport - all in one plateform
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
