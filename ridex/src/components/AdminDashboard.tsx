    ...
    <div className='min-h-screen bg-linear-to-br from-gray-100 to-gray-200 '>
      ...
      <main className='max-w-7xl mx-auto px-6 py-12 space-y-16' >
        <div className='grid grid-cols-2 sm:grid-cols-4 gap-6'>
          <Kpi label="Total Partner" value={stats?.totalPartners} icon={<User />} variant={"totalPartners"} />
          <Kpi label="Approved Partner" value={stats?.totalApprovedPartners} icon={<CheckCircle2 />} variant={"approved"} />
          <Kpi label="Pending Partner" value={stats?.totalPendingPartners} icon={<Clock />} variant={"pending"} />
          <Kpi label="Rejected Partner" value={stats?.totalRejectedPartners} icon={<XCircle />} variant={"rejected"} />
        </div>
